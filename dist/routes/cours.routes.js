...
router.post('/', auth_middleware_1.isAuthenticated, (0, auth_middleware_1.hasRole)('FORMATEUR'), wrap(cours_controller_1.CoursController.create));
router.put('/:id', auth_middleware_1.isAuthenticated, (0, auth_middleware_1.hasRole)('FORMATEUR'), wrap(cours_controller_1.CoursController.update));
